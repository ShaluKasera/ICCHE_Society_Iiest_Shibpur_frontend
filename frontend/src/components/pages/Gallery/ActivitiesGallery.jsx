...
const ActivitiesGallery = () => {
  ...
  useEffect(() => {
    ...
    const fetchGallery = async () => {
      try {
        const response = await axios.get("http://localhost:8000/api/admin/dashboard/gallery/activities/photos");
  ...
  const deleteItem = async (itemId) => {
    try {
      await axios.delete(`http://localhost:8000/api/admin/dashboard/gallery/activities/photos/${itemId}`, {
