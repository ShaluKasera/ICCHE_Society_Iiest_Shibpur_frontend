  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint =
      formData.mediaType === "photo"
        ? "https://iccheweb.vercel.app/api/admin/dashboard/festivalGallery/photos/add-photos"
        : "https://iccheweb.vercel.app/api/admin/dashboard/festivalGallery/videos/add-videos";
...
export default AddFestivalImages
