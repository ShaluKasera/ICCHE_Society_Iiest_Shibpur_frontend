  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint =
      formData.mediaType === "photo"
        ? "https://iccheweb.vercel.app/api/admin/dashboard/inductionGallery/photos/add-photos"
        : "https://iccheweb.vercel.app/api/admin/dashboard/inductionGallery/videos/add-videos";
    ...
    <Layout>
      ...
      <div className="w-[90%] max-w-sm mx-auto p-6 min-w-2xs bg-white rounded-lg shadow-lg text-xs sm:text-base mt-20 flex flex-col items-center justify-center">
        <h2 className="text-2xl text-center font-semibold text-gray-700 mb-6">
          Add to Induction images & videos
        </h2>
...
export default AddInductionImages
